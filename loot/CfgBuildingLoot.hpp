...
class CfgBuildingLoot {
	...
	class Residential: Default {
		...
		lootType[] = {
			...
			{"clothes","clothes",0.07},
			{"specialclothes","specialclothes",0.03},
	...
	class Office: Default {
		...
		lootTypeSmall[] = {
			...
			{ "ItemSodaRbull","magazine",0.02},
			{ "ItemSodaOrangeSherbet","magazine",0.07 },
	...
	class SupplyDrop: Default {
		...
		lootType[] = {
			...
			{ "bulk_ItemTankTrap", "magazine", 0.2 },
			{ "ItemSledge", "weapon", 0.2 }
		};
	};
