...
// general settings
_folder = "script\service_point\"; // folder where the service point scripts are saved, relative to the mission file
...
_costsFree = "gratuit"; // text for no costs
...
_refuel_costs = [
	...
	["AllVehicles",["ItemGoldBar10oz",1]] // 2 Gold for all other vehicles]; // free for all vehicles (equal to [["AllVehicles",[]]])
];
