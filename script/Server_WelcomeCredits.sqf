...
_role1 = "Welcome to";
_role1names = ["The World Of The DayZhydrated [DzY]"];
_role2 = "Rules";
_role2names = ["No Safezone Camping","Be Smart & Fairplay", "Any Trouble? Ask An Admin"];
_role3 = "Server mod";
_role3names = ["DayZ Epoch 1.0.5.1 NAPF"];
_role4 = "New Server";				//The "by" in this row will be shown one row below "Server antihack". Can be applied to any role
_role4names = ["Fresh Database", "Custom Loot", "Custom Traders Prices","Clans Welcome","New Players Package"];
_role5 = "Add ons";
_role5names = ["Caravan Traders", "RightClick Options", "Ai Missions"];
_role6 = "Add ons";
_role6names = ["Refuel/Repair Station","Take Clothes", "Snapping", "Deploy Vehicles"];
_role7 = "W.I.P";
_role7names = ["More Addons Soon"];
_role8 = "Mumble";
_role8names = ["192.162.70.29:64738"];
_role9 = "Admins";
_role9names = ["Arkmal", "Steph"];
