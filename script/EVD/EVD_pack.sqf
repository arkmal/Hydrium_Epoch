...
if (dayz_combat == 1) exitwith { cutText ["\n\n Mode Combat, construction annulée!", "PLAIN DOWN"] };

private ["_obj","_animState","_started","_finished"];

if(DZE_ActionInProgress) exitWith { cutText ["Rangement du véhicule déjà en cours." , "PLAIN DOWN"]; };
...
cutText ["Rangement du véhicule", "PLAIN DOWN"];
...
if (_finished) then {
	...
	cutText ["Annulation du rangement du vehicule", "PLAIN DOWN"];
};
